...
//
//import com.example.demograph.ui.CustomGraphRenderer
...
//    private var isPanMode = false // Biến theo dõi chế độ pan
//
//    init {
//        // Cấu hình mxGraph
...
//        toolbar.add(createButton("Toggle Pan Mode") { togglePanMode() }) // Nút mới
//
...
//    }
//
//    private fun togglePanMode() {
//        isPanMode = !isPanMode
//        // Cập nhật cấu hình graphComponent
//        graphComponent.isPanning = isPanMode
//        graph.isCellsSelectable = !isPanMode // Vô hiệu hóa chọn node khi ở chế độ pan
//        graph.isCellsEditable = !isPanMode // Vô hiệu hóa chỉnh sửa node
//        graphComponent.isDragEnabled = !isPanMode // Vô hiệu hóa kéo thả node
//        // Cập nhật văn bản nút
//        val button = graphComponent.parent.components
//            .filterIsInstance<JToolBar>()
//            .flatMap { it.components.toList() }
//            .filterIsInstance<JButton>()
//            .find { it.text == "Toggle Pan Mode" }
//        button?.text = if (isPanMode) "Disable Pan Mode" else "Enable Pan Mode"
//        println("Pan mode: $isPanMode")
//    }
//
...
//            } else {
//                JOptionPane.showMessageDialog(this, "graph.json not found")
