...
class NodeEditDialog {
    companion object {
         ...
         * 
         * @param parent The parent component (GraphComponent) that contains the cell
         * @param cell The cell to edit
         * @param graph The graph containing the cell
         */
        fun showEditDialog(parent: com.mxgraph.swing.mxGraphComponent, cell: mxCell, graph: mxGraph) {
            ...
            val dialog = JDialog(SwingUtilities.getWindowAncestor(parent) as Frame, "Edit Node", true)
            ...
            val headerLabel = JLabel("Edit Node Text")
            ...
            updateButton.addActionListener {
                ...
                try {
                    // Create the updated node content
                    val updatedContent = createNodeContentFromText(textArea.text)
                    graph.model.setValue(cell, updatedContent)
                } finally {
        ...
        fun createQueryNodeContent(queryText: String): String {
            return """
            <table style="width:${GraphManager.NODE_WIDTH - 30}px; color:#fff; font-family:Arial; font-size:9px;margin-top:30px;padding-left:20px;">
                <tr><td>${escapeHtml(queryText)}</td></tr> 
        ...
        /**
         * Creates HTML content for a generic node
         */
        fun createNodeContentFromText(text: String): String {
            return """
            <table style="width:${GraphManager.NODE_WIDTH - 30}px; color:#fff; font-family:Arial; font-size:9px;margin-top:30px;padding-left:20px;">
        ...
        fun createStepNodeContent(stepName: String, guideText: String): String {
            return """
               <table style="width:${GraphManager.NODE_WIDTH - 30}px; color:#fff; font-family:Arial; font-size:9px;margin-top:30px;padding-left:20px;">
                  <tr><td>${escapeHtml(guideText)}</td></tr>
                  <tr><td style="font-weight:bold; opacity:0.7;">${escapeHtml(stepName)}</td></tr>
                </table>
            """.trimIndent()
        }
